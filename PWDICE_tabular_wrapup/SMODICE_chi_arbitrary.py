...
from SMODICE_chi_cvxpy import SMODICE_Solver
...
if __name__ == "__main__": 
    ...
    f = open("res/LDexperiment/SMODICE-CHI/SMODICE-CHI-"+str(args.TA_expert_traj)+"-"+str(args.N_expert_traj)+"-"+str(args.noise_level)+".txt", 'w')
    ...
    for data_index in range(10):
        ...
        for i, solver in enumerate([SMODICE_Solver(MDP, MDP_estimate, runtime, visualize=False), SMODICE_Solver(MDP, MDP_estimate_exact, runtime, visualize=False)]):
